...
def _env_or_config(name, default=''):
    ...
    if name in LOCAL_ENV_VALUES:
        return str(LOCAL_ENV_VALUES.get(name, default)).strip()
...
USE_CLOUDINARY_IN_DEBUG = _to_bool(_env_or_config('USE_CLOUDINARY_IN_DEBUG', 'False'), default=False)
USE_CLOUDINARY_STORAGE = USE_CLOUDINARY_STORAGE and (IS_PRODUCTION or USE_CLOUDINARY_IN_DEBUG)
...
EMAIL_HOST = _env_or_config('EMAIL_HOST', 'smtp.gmail.com')
EMAIL_PORT = int(_env_or_config('EMAIL_PORT', '587') or 587)
EMAIL_USE_TLS = _to_bool(_env_or_config('EMAIL_USE_TLS', 'True'), default=True)
EMAIL_USE_SSL = _to_bool(_env_or_config('EMAIL_USE_SSL', 'False'), default=False)
EMAIL_TIMEOUT = int(_env_or_config('EMAIL_TIMEOUT', '15') or 15)
EMAIL_HOST_USER = _env_or_config('EMAIL_HOST_USER', '')
EMAIL_HOST_PASSWORD = _env_or_config('EMAIL_HOST_PASSWORD', '')
if 'gmail' in EMAIL_HOST.lower() and ' ' in EMAIL_HOST_PASSWORD:
    # Gmail App Passwords are often pasted with spaces; SMTP expects the compact token.
    EMAIL_HOST_PASSWORD = EMAIL_HOST_PASSWORD.replace(' ', '')
if EMAIL_USE_SSL and EMAIL_USE_TLS:
    EMAIL_USE_TLS = False
DEFAULT_FROM_EMAIL = _env_or_config('DEFAULT_FROM_EMAIL', EMAIL_HOST_USER)
...
FRONTEND_URL = config('FRONTEND_URL', default='http://swifcart21-1.onrender.com')
